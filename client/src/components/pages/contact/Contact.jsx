...
const Contact = () => {
  ...
  return (
    <div>
            ...
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  <span className="text-[#3D925A] mb-4 block sm:text-4xl text-xl font-semibold">
                    Contactez-nous
                  </span>
                  <p className="text-gray-700 mb-9 text-base leading-relaxed">
                    Nous sommes là pour vous aider à atteindre vos objectifs immobiliers.
                    Remplissez le formulaire ci-dessous et un membre de notre équipe vous contactera sous peu.
                  </p>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-body-color text-base">
                        Rue tunis imb Samira Apt 1. 62000, Nador
                      </p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="bg-primary border-primary w-full bg-[#3D925A] hover:bg-[#3D925A]/80 rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Envoyer
                      </button>
                    </div>
      ...
      <Location />
      <div classNameName="flex justify-end ml-[30%] w-[70%] h-[2px] bg-gradient-to-r from-blue-400 to-violet-500"></div>
    </div>
  );
};
