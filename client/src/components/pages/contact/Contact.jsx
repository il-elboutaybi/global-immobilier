            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  <span class="text-[#3D925A] mb-4 block sm:text-4xl text-xl font-semibold">
                    Contactez-nous
                  </span>
                ...
                <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div>
                      <button
                        type="submit"
                        class="bg-primary border-primary w-full bg-[#3D925A] hover:bg-[#3D925A]/80 rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Envoyer
                      </button>
                    </div>
