              ...
              <div>
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                  <div className="lg:col-start-2">
                    ...
                    <p className="mt-3 text-lg dark:text-gray-600">Chez Global Immobilière, nous ne nous contentons pas de vous proposer des investissements rentables. Nous nous engageons à vous offrir des opportunités uniques et visionnaires qui vous permettront de garder une longueur {"d'"}avance sur le marché immobilier.</p>
                    <div className="mt-12 space-y-12">
                      <div className="flex">
                        <div className="flex-shrink-0">
                          <div className="flex items-center justify-center w-12 h-12 rounded-md">
